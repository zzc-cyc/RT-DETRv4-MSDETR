...
from .two_stage_criterion import get_vfl_loss
...
class DINOCriterion(TwoStageCriterion):
    ...
    def compute_dn_loss(self, dn_metas, targets, aux_num, num_boxes):
        ...
        if dn_metas and "output_known_lbs_bboxes" in dn_metas:
            ...
            l_dict.update(get_vfl_loss(output_known_lbs_bboxes, targets, dn_idx, num_boxes * dn_num))
            ...
            losses["loss_vfl_dn"] = torch.as_tensor(0.0).to("cuda")
        ...
        for i in range(aux_num):
            ...
            if dn_metas and "output_known_lbs_bboxes" in dn_metas:
                ...
                l_dict.update(get_vfl_loss(output_known_lbs_bboxes_aux, targets, dn_idx, num_boxes * dn_num))
                ...
                l_dict["loss_vfl_dn"] = torch.as_tensor(0.0).to("cuda")
