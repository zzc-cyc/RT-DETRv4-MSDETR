...
class Trainer(SimpleTrainer):
    ...
    def __init__(
        ...
        self.current_iter = 1
        self.grad_accum_steps = grad_accumulate_steps
    ...
    def run_step(self):
        ...
        if self.amp:
            ...
            if (self.current_iter + 1) % self.grad_accum_steps == 0:
...
def do_train(args, cfg):
    ...
    optim = torch.optim.AdamW(param_dicts, 5e-5, weight_decay=5e-2)
    ...
    trainer = Trainer(
        ...
        grad_accumulate_steps=args.grad_accum_steps,
    )
